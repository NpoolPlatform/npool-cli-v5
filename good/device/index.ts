...
export const useDeviceTypeStore = defineStore('device-types', {
  ...
  actions: {
    ...
    createDeviceType (req: AdminCreateDeviceTypeRequest, done: (error: boolean, device?: DeviceType) => void) {
    ...
    deleteDeviceType (req: AdminDeleteDeviceTypeRequest, done: (error: boolean, device?: DeviceType) => void) {
