...
export * as couponcoin from './inspire/coupon/app/coin'
...
export * as localuser from './appuser/user/local'
...
export * as goodcomment from './good/good/comment'
...
export * as goodrewardhistory from './good/good/reward/history'
export * as cmscategory from './cms/category'
export * as cmsarticle from './cms/article'
